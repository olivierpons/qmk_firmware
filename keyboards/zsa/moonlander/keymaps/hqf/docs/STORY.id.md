...
Sejak awal saya menambahkan makro mouse-jiggle, agar komputer tidak terkunci atau idle selama panggilan panjang atau bacaan panjang. Awalnya kursor hanya bergeser sedikit setiap 800 md; sekarang ia mengikuti sebuah lingkaran piksel demi piksel. `M_JG_TOG` menyalakan dan mematikannya sambil membiarkan kursor di tempatnya: saat dinyalakan lagi, ia melanjutkan dari titik yang sama, dengan pengaturan yang sama. `M_JG_RUP` / `M_JG_RDN` memperbesar dan memperkecil jari-jari (10 piksel secara bawaan, hingga satu piksel saja, yang tetap menggerakkan mouse), dan `M_JG_DUP` / `M_JG_DDN` memperpanjang dan memperpendek jeda antara dua piksel (1 detik secara bawaan, hingga 1 md, lalu lebih cepat lagi, sampai 100 piksel per milidetik). Pada keempat tombol ini, tekanan singkat, seperti mengetik satu huruf, mengubah nilai sebesar 1, dan menahan tombol mengubahnya 10 sekaligus, makin lama makin cepat. `M_JG_CTG` memilih di mana klik kiri terjadi di setiap putaran: setiap tekanan pindah ke arah berikutnya dari delapan arah, utara, timur laut, timur, tenggara, selatan, barat daya, barat, barat laut, dengan bunyi bip ganda yang sedikit lebih tinggi setiap kali, lalu mematikan klik dengan bunyi bip rendah.
